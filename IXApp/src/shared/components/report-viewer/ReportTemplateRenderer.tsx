/**
 * Centralized Print Engine — Runtime Template Renderer
 *
 * Renders a PrintTemplateDocument JSON definition into React/MUI elements
 * suitable for screen display and print output. This component is fully generic
 * and can be used by any module — Workflow, Finance, Organization, etc.
 */
...
import { resolveRuntimeBinding, type runtimeReportData } from './runtimeReportData';
...
const isVisible = (element: PrintTemplateElement, data: runtimeReportData): boolean => {
...
export function ReportTemplateRenderer({ template, data, company, renderRequestControl, layoutMode = 'document' }: Props): React.ReactElement {

...
{
    public class ShowroomService : BaseService<Showroom>, IShowroomService
    {
        private readonly IGenericRepository<IAX.IXApi.Modules.Organization.Employees.Entities.HcmWorker> _employees;

        public ShowroomService(IUnitOfWork unitOfWork, ICurrentUserService currentUser) : base(unitOfWork, currentUser)
        {

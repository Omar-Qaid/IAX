...
public sealed partial class WfProcess590SeedData
{
        ...
        CancellationToken ct)
    {
        ...
        var items = new[]
        {
            ...
            new { RecId = 20530L, ProcessId = 590L, ControlId = (byte)18, Name = "Name of showroom", NameAlias = " اسم الفرع", SortOrder = (byte)2, ExtendedProperties = "", IsActive = true, IsMandatory = true, Score = 0.00m, ReferenceType = "Showroom", FieldRole = "Dimension", DefaultAggregation = "NONE", DataType = "String", CanFilter = true, CanGroup = true, CanSort = true },

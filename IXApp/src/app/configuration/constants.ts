...
export const API_ENDPOINTS = {
    ...
    OCCUPATIONS: '/HcmOccupation',
    NATIONALITIES: '/HcmNationality',
    HCM_DEPARTMENTS: '/HcmDepartment',
    HCM_OCCUPATIONS: '/HcmOccupation',
    HCM_NATIONALITIES: '/HcmNationality',
    GENDERS: '/Gender',
    EMPLOYEES: '/Employee',

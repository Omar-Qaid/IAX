...
public class WorkflowConditionEvaluatorTests
{
    ...
    [InlineData("INT", "OP1", "11", "10", true)]
    [InlineData("INT", "OP2", "11", "10", false)]
    [InlineData("INT", "OP3", "10", "10", true)]
    [InlineData("INT", "OP4", "10", "10", true)]
    [InlineData("STR", "OP5", "Finance", "finance", true)]
    [InlineData("STR", "OP5", "Finance", "sales", false)]
    [InlineData("BOOL", "OP6", "true", "false", true)]
    [InlineData("INT", "OP7", "10", "[\"10\",\"20\"]", true)]
    [InlineData("INT", "OP7", "21", "[\"10\",\"20\"]", false)]

    ...
    public partial class CreateDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Announcements", x => x.RecId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchJobActivePeriod", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataPartition = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
                    EndDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    EndDateTimeTzId = table.Column<int>(type: "int", nullable: true),
                    Finishing = table.Column<int>(type: "int", nullable: false),
                    LogLevel = table.Column<int>(type: "int", nullable: false),
                    OrigStartDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    OrigStartDateTimeTzId = table.Column<int>(type: "int", nullable: true),
                    RecurrenceData = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    RuntimeJob = table.Column<int>(type: "int", nullable: false),
                    StartDateTime = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StartDateTimeTzId = table.Column<int>(type: "int", nullable: true),
                    StartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StartTime = table.Column<int>(type: "int", nullable: true),
                    Critical = table.Column<int>(type: "int", nullable: false),
                    MonitoringCategory = table.Column<int>(type: "int", nullable: false),
                    Managed = table.Column<int>(type: "int", nullable: false),
                    ExecutingBy = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ActivePeriod = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    SchedulingPriority = table.Column<int>(type: "int", nullable: false),
                    SchedulingPriorityIsOverridden = table.Column<int>(type: "int", nullable: false),
                    BatchGroup = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    EmitBusinessEvent = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchJobs", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Departments", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeGroups", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Genders", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationHierarchies", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationRoles", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationUnitType = table.Column<byte>(type: "tinyint", nullable: false),
                    ...
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    NameAlias = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationUnits", x => x.RECID);
                    table.CheckConstraint("CK_OrganizationUnits_Dates", "[ValidTo] IS NULL OR [ValidTo] > [ValidFrom]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutionUserId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    OwnerAccountId = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                    PreserveChannel = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ControlLabelAR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    ControlValueAR = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ControlValueEN = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Score = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    EarnedScore = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    RelatedObjectId = table.Column<long>(type: "bigint", nullable: false, defaultValue: 0L),
                    UsedAsCriteria = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AlertsProcessed = table.Column<int>(type: "int", nullable: false),
                    BatchCreatedBy = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CanceledBy = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    ...
                    RuntimeJob = table.Column<int>(type: "int", nullable: false),
                    BatchGroup = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    GroupSchedulingPriority = table.Column<int>(type: "int", nullable: false),
                    JobSchedulingPriority = table.Column<int>(type: "int", nullable: false),
                    JobSchedulingPriorityIsOverridden = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchJobHistory", x => x.RECID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchJobTasks", x => x.RecId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysBackgroundJobRecurrenceCounts", x => x.RECID);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HcmPositions", x => x.RECID);
                    table.CheckConstraint("CK_HcmPositions_Dates", "[ValidTo] IS NULL OR [ValidTo] > [ValidFrom]");
                    table.ForeignKey(
                        name: "FK_HcmPositions_OrganizationRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "OrganizationRoles",
                        principalColumn: "RECID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_HcmPositions_OrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateTable(
                name: "OrganizationHierarchyNodes",
                columns: table => new
                {
                    RECID = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationHierarchyNodes", x => x.RECID);
                    table.CheckConstraint("CK_OrganizationHierarchyNodes_Dates", "[ValidTo] IS NULL OR [ValidTo] > [ValidFrom]");
                    table.ForeignKey(
                        name: "FK_OrganizationHierarchyNodes_OrganizationHierarchies_HierarchyId",
                        column: x => x.HierarchyId,
                        principalTable: "OrganizationHierarchies",
                        principalColumn: "RECID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationHierarchyNodes_OrganizationHierarchyNodes_ParentNodeId",
                        column: x => x.ParentNodeId,
                        principalTable: "OrganizationHierarchyNodes",
                        principalColumn: "RECID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrganizationHierarchyNodes_OrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "OrganizationUnits",
                        principalColumn: "RECID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeCategoryGroups", x => x.RECID);
                    table.ForeignKey(
                        name: "FK_EmployeeCategoryGroups_Departments_DepartmentID",
                        column: x => x.DepartmentID,
                        principalTable: "Departments",
                        principalColumn: "RECID");
                    table.ForeignKey(
                        name: "FK_EmployeeCategoryGroups_EmployeeGroups_UserGroupID",
                        column: x => x.UserGroupID,
                        principalTable: "EmployeeGroups",
                        principalColumn: "RECID");
                    table.ForeignKey(
                        name: "FK_EmployeeCategoryGroups_Occupations_OccupationID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepeatIntervalHours = table.Column<byte>(type: "tinyint", nullable: false),
                    MandatoryDocuments = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BatchJobTaskHistory", x => x.RecId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WFProcessScheduled_WfProcesses_ProcessId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SortOrder = table.Column<byte>(type: "tinyint", nullable: false),
                    Score = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    MustCompleteAll = table.Column<bool>(type: "bit", nullable: false),
                    IsSystemDefined = table.Column<bool>(type: "bit", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsSystemNotificationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    ...
                    IsWhatsAppNotificationEnabled = table.Column<bool>(type: "bit", nullable: false),
                    MandatoryDocuments = table.Column<bool>(type: "bit", nullable: false),
                    IsAutoPassEnabled = table.Column<bool>(type: "bit", nullable: false),
                    AutoPassAfterHours = table.Column<byte>(type: "tinyint", nullable: false),
                    IsRecurringReminderEnabled = table.Column<bool>(type: "bit", nullable: false),
                    RecurringReminderIntervalHours = table.Column<byte>(type: "tinyint", nullable: false),
                    MaxReminderOccurrences = table.Column<byte>(type: "tinyint", nullable: false),
                    CanViewPreviousSteps = table.Column<bool>(type: "bit", nullable: false),
                    CanViewPreviousDocuments = table.Column<bool>(type: "bit", nullable: false),
                    ExtendedProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ValidationRules = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ExtendedProperties = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CanFilter = table.Column<bool>(type: "bit", nullable: false),
                    CanGroup = table.Column<bool>(type: "bit", nullable: false),
                    CanSort = table.Column<bool>(type: "bit", nullable: false),
                    ReferenceType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FieldRole = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DataType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DefaultAggregation = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BatchJobActivePeriod_DataAreaId_ID",
                table: "BatchJobActivePeriod",
                columns: new[] { "DataAreaId", "ID" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCategoryGroups_DepartmentID",
                table: "EmployeeCategoryGroups",
                column: "DepartmentID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCategoryGroups_OccupationID",
                table: "EmployeeCategoryGroups",
                column: "OccupationID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCategoryGroups_UserCategoriesID",
                table: "EmployeeCategoryGroups",
                column: "UserCategoriesID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeCategoryGroups_UserGroupID",
                table: "EmployeeCategoryGroups",
                column: "UserGroupID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeGroupDetails_UserID",
                table: "EmployeeGroupDetails",
                column: "UserID");

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeManagers_ManagementLevelId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HcmPositions_OrganizationUnitId",
                table: "HcmPositions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HcmWorkerOrganizationAssignments_DataAreaId_HcmWorkerId_IsPrimary_ValidFrom_ValidTo",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "HcmWorkerOrganizationAssignments",
                columns: new[] { "OrganizationUnitId", "AssignmentRole", "ValidFrom", "ValidTo" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHierarchies_DataAreaId_Code",
                table: "OrganizationHierarchies",
                columns: new[] { "DataAreaId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHierarchyNodes_DataAreaId_HierarchyId_OrganizationUnitId_ValidFrom_ValidTo",
                table: "OrganizationHierarchyNodes",
                columns: new[] { "DataAreaId", "HierarchyId", "OrganizationUnitId", "ValidFrom", "ValidTo" });

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHierarchyNodes_HierarchyId",
                table: "OrganizationHierarchyNodes",
                column: "HierarchyId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHierarchyNodes_OrganizationUnitId",
                table: "OrganizationHierarchyNodes",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationHierarchyNodes_ParentNodeId",
                table: "OrganizationHierarchyNodes",
                column: "ParentNodeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationRoles_DataAreaId_Code",
                table: "OrganizationRoles",
                columns: new[] { "DataAreaId", "Code" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_OrganizationUnits_DataAreaId_Code",
            ...
            migrationBuilder.CreateIndex(
                ...
                table: "SysBackgroundJobGroup",
                columns: new[] { "DataAreaId", "GroupCode" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WFProcessScheduled_BackgroundJobId",
                table: "WFProcessScheduled",
                column: "BackgroundJobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WFProcessScheduled_DataAreaId_ProcessId",
                table: "WFProcessScheduled",
                columns: new[] { "DataAreaId", "ProcessId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WFProcessScheduled_ProcessId",
                table: "WFProcessScheduled",
                column: "ProcessId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WfRequests_HcmWorkerAssignmentId",
                table: "WfRequests",
                column: "HcmWorkerAssignmentId");

            migrationBuilder.CreateIndex(
                name: "IX_WfRequests_OrganizationUnitId",
                table: "WfRequests",
                column: "OrganizationUnitId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WfRequests_RequestForHcmWorkerId",
                table: "WfRequests",
                column: "RequestForHcmWorkerId");

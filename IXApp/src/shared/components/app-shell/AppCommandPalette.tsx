...
const ALL_PAGES: PageItem[] = [
    ...
    // Data Pages (Mock examples for the palette)
    { id: 'customers', label: 'nav.customers', path: '/customers', icon: <PeopleIcon sx={iconSx} />, category: 'Data' },
    { id: 'customer-groups', label: 'nav.customer_groups', path: '/customer-groups', icon: <GroupWorkIcon sx={iconSx} />, category: 'Data' },

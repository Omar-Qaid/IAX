...
public sealed partial class WfProcess590SeedData
{
    ...
    {
        const long processId = 590L;
        const string processName = "List of quality and performance standards at points of sale";
        const string processNameAlias = "لائحة معايير الجودة والاداء بنقاط البيع";
        ...
        // For the seeded request 127677
        var requestId = 127677L;

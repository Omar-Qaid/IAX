...
export function WorkflowReportDesigner({
  processId,
  document,
  onChange,
  isDefault = false,
  ...
  const { t } = useAppTranslation();
  const designer = useReportDesigner(document, onChange);
  ...
  return (
    <ReportDesigner
      ariaLabel={t('printTemplates.designer.title')}
      sidebarWidth={190}
      propertiesWidth={250}
      isLoading={requestControls.isLoading}
      loadingMessage={t('messages.loadingData')}
      toolbar={
        <Stack

...
export interface EnterpriseListDetailsConfig<T extends ListDetailRecord> {
  ...
  yesLabel: string;
  noLabel: string;
  crud: { editLabel: string; newLabel: string; deleteLabel: string; saveLabel: string; cancelLabel: string };
  commands?: ListDetailsCommand[];
  utilities: { personalizeLabel: string; guideLabel: string; notificationsLabel: string; refreshLabel: string; openWindowLabel: string; notificationCount?: number };

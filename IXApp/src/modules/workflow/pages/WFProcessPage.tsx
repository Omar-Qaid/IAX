...
export function WFProcessPage(): React.ReactElement {
  ...
  const config: EnterpriseListDetailsConfig<WfProcessRecord> = {
    ...
    getValues: (record): DetailValues => ({
      ...
      repeatIntervalHours: record.repeatIntervalHours,
    ...
    setValues: (record, values) => ({
      ...
      repeatIntervalHours: numberValue(values.repeatIntervalHours),
      isRepeatable: Boolean(values.isRepeatable),
      mandatoryDocuments: Boolean(values.mandatoryDocuments),
      isSystemDefined: Boolean(values.isSystemDefined),
    }),
    headerFields: [
      {
        id: 'code',

...
namespace IAX.IXApi.Infrastructure.Persistence
{
    public class ApplicationDbContext : IdentityDbContext<
        ...
        AspNetUserToken  
      >
     , IAX.IXApi.Modules.Identity.Persistence.IIdentityDataContext,
       ...
       IAX.IXApi.Modules.Workflow.Persistence.IWorkflowDataContext
     {
        ...
        {
            var party = new IAX.IXApi.Modules.Finance.Entities.DirPartyTable
            {
                Name = name,
                NameAlias = nameAlias,
            ...
            Set<IAX.IXApi.Modules.Finance.Entities.DirPartyTable>().Add(party);
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(IAX.IXApi.Modules.Identity.IdentityModule).Assembly);
            modelBuilder.ApplyConfigurationsFromAssembly(typeof(IAX.IXApi.Modules.Administration.AdministrationModule).Assembly);

namespace IAX.IXApi.Modules.Finance.Foundation.LegalEntities
{
    public class CompanyInfoDto
    {
        ...
        public List<IAX.IXApi.Modules.Finance.Foundation.LogisticsAddresses.AddressInfoDto> Addresses { get; set; } = new();
        public List<IAX.IXApi.Modules.Finance.Foundation.LogisticsAddresses.ContactInfoDto> Contacts { get; set; } = new();
    }

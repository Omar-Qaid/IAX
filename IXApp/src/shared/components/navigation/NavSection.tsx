...
export const NavSection = React.memo<NavSectionProps>(({
    ...
    const headerHoverBg = isApparent ? 'rgba(255, 255, 255, 0.06)' : (isDark ? 'rgba(255,255,255,0.02)' : '#f5f5f5');
    const headerActiveBg = isApparent ? 'rgba(255, 255, 255, 0.03)' : (isDark ? 'rgba(255,255,255,0.02)' : '#f5f5f5');
    const borderBottomColor = isApparent ? 'rgba(255, 255, 255, 0.08)' : (isDark ? 'rgba(255,255,255,0.05)' : '#f3f2f1');

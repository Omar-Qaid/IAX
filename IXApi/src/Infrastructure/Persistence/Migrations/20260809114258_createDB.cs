    ...
    public partial class createDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgAttachments", x => x.AttachmentId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    LogoUrl = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    ColorTheme = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ColorMode = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgCompanies", x => x.RECID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SmallestValue = table.Column<long>(type: "bigint", nullable: false),
                    LargestValue = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    ResetCycle = table.Column<byte>(type: "tinyint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrgAttachmentRecId = table.Column<long>(type: "bigint", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrgAttachmentDetails", x => x.RECID);
                    table.ForeignKey(
                        name: "FK_OrgAttachmentDetails_OrgAttachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "OrgAttachments",
                        principalColumn: "AttachmentId");
                    table.ForeignKey(
                        name: "FK_OrgAttachmentDetails_OrgAttachments_OrgAttachmentRecId",
                        column: x => x.OrgAttachmentRecId,
                        principalTable: "OrgAttachments",
                        principalColumn: "AttachmentId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformerNameAR = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ErrorMessageAr = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
                    ErrorMessageEn = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WfRequests_OrgAttachments_AttachmentId",
                        column: x => x.AttachmentId,
                        principalTable: "OrgAttachments",
                        principalColumn: "AttachmentId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "WfDataTypes",
                columns: new[] { "RECID", "Code", "CreatedAt", "CreatedBy", "DataAreaId", "Description", "DescriptionAR", "IsActive", "IsDeleted", "LastModifiedAt", "LastModifiedBy", "Name", "NameAR", "OwnerAccountId", "RecVersion", "SortOrder" },
                values: new object[,]
                {
                    { (byte)1, "STR", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "dat", null, null, true, false, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "String", "نص", null, 1, (byte)1 },
                    { (byte)2, "NUM", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "dat", null, null, true, false, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Number", "رقم", null, 1, (byte)2 },
                    { (byte)3, "BOOL", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "dat", null, null, true, false, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Boolean", "منطقي", null, 1, (byte)3 },
                    { (byte)4, "DATE", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "dat", null, null, true, false, new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), null, "Date", "تاريخ", null, 1, (byte)4 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgAttachmentDetails_AttachmentId",
                table: "OrgAttachmentDetails",
                column: "AttachmentId");

            migrationBuilder.CreateIndex(
                name: "IX_OrgAttachmentDetails_OrgAttachmentRecId",
                table: "OrgAttachmentDetails",
                column: "OrgAttachmentRecId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WfRequests_AttachmentId",
                table: "WfRequests",
                column: "AttachmentId");

/**
 * Centralized Print Engine — Template Designer Hook
 *
 * Provides element tree CRUD operations (add, update, remove, move, select)
 * for any visual template designer. Works on the generic PrintTemplateElement[]
 * tree with no domain coupling.
 */

import React from 'react';
import type { PrintTemplateDocument, PrintTemplateElement } from './types';

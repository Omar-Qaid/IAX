            ...
            await strategy.ExecuteAsync(async () =>
            {
                ...
                try
                {
                    ...
                    if (addresses != null && addresses.Any())
                    {
                        ...
                        var existingPostalLocs = existingLocations.Where(x => x.IsPostalAddress == IAX.IXApi.Modules.ERP.Common.NoYes.Yes).ToList();
                    ...
                    {
                        var firstContactLoc = existingLocations.FirstOrDefault(x => x.IsPostalAddress == IAX.IXApi.Modules.ERP.Common.NoYes.No);

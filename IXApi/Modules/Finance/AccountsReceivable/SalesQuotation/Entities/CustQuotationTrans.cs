...
namespace IAX.IXApi.Modules.Finance.AccountsReceivable
{
    ...
    public class CustQuotationTrans : Entity<long>
    {
        //----------------------------------------- Core Information
        // Basic Properties
        ...
        // ==========================================================
        // Financials & Accounting Currency (MST)
        // ==========================================================
        // Basic Properties
        ...
        public string ProjDescription { get; set; } = string.Empty;
        [StringLength(FieldLengths.ProjLinePropertyId)]
        public string LinePropertyId { get; set; } = string.Empty;
...
//         public virtual CustQuotationJour? CustQuotationJour { get; set; }

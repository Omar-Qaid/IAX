/**
 * Centralized Print Engine — Template Element Preview
 *
 * Design-time wireframe renderer for all template element types.
 * Shows a clickable, interactive preview of each element in the designer
 * canvas. Fully generic — no domain coupling.
 */
...
export function ReportDesignerElementPreview({
  element,
  region,
  selectedId,
  onSelect,

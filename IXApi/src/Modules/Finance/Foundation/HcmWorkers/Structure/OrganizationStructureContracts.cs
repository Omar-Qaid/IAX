...
public sealed record CreateOrganizationHierarchyWithRootNode(string Code, string Name, string Purpose, long OrganizationUnitId, DateOnly ValidFrom, DateOnly? ValidTo);

...
const DeleteIcon = (props: SvgIconProps) => (
  <SvgIcon {...props}>
    <path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12Zm3.5-9h1v8h-1v-8Zm4 0h1v8h-1v-8ZM15.5 4l-1-1h-5l-1 1H5v2h14V4z" />
  </SvgIcon>
);
const SaveIcon = (props: SvgIconProps) => (
  <SvgIcon {...props}>
    <path d="M5 3h12l3 3v15H4V3h1Zm2 2v5h9V5H7Zm0 9v5h10v-5H7Z" />
  </SvgIcon>
);
...
export const EnterpriseCrudActions: React.FC<EnterpriseCrudActionsProps> = ({
  editLabel,
  newLabel,
  deleteLabel,
  canEdit,

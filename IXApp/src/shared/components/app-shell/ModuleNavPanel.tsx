...
import {
    ...
    AddBoxOutlined as ExpandAllIcon,
    IndeterminateCheckBoxOutlined as CollapseAllIcon,
    People as PeopleIcon,
    PersonAdd as PersonAddIcon,
    AttachMoney as MoneyIcon,
    CardGiftcard as BenefitsIcon,
    PersonOutlined as SelfServiceIcon,
                                    ...
                                    <Box sx={getLinkContainerSx(!!isMobileView)}>
                                        {section.links.map((link) => (
                                            link.expandable ? (
                                                <Box
                                                    key={link.label}
                                                    sx={getExpandableLinkSx(!!isMobileView)}
                                                >
                                                ...
                                                >
                                                    {link.icon && (
                                                        <Box sx={linkIconWrapperSx}>
                                                            {ICON_MAP[link.icon] || FALLBACK_ICON}
                                                        </Box>
                                                    )}
                                                    <Typography
                                                        className="link-text"
                                                        sx={getLinkTextSx(!!isMobileView)}
                                                    >
                                                        {t(link.label)}
                                                    </Typography>
                                                </Box>

...
export function WorkflowMailReportViewerBody({ request, details, processName, showNotes = true }: { request: WfRequestRecord; details: MailRequestDetailsDto; processName?: string; showNotes?: boolean }): React.ReactElement {

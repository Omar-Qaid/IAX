...
using IAX.IXApi.Modules.Finance.AccountsReceivable.PostingProfile.Interfaces;

namespace IAX.IXApi.Modules.Finance.AccountsReceivable.PostingProfile.Services
{

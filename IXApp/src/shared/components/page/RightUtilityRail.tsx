...
export const RightUtilityRail: React.FC<RightUtilityRailProps> = ({ filterLabel, informationLabel, onFilter, onInformation, filterActive = false, informationActive = false, showInformation = true, disabled = false }) => (
  <Box
    ...
    sx={{ position: 'absolute', insetInlineEnd: 0, top: 0, bottom: 0, width: d365.utilityRailWidth, minHeight: 0, boxSizing: 'border-box', overflow: 'hidden', borderInlineStart: `1px solid ${d365.border}`, bgcolor: d365.surface, display: { xs: 'none', lg: 'flex' }, alignItems: 'center', flexDirection: 'column', pt: 0.25, gap: 0.5, zIndex: 3 }}
  >
